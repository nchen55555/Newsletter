            ...
            <div className="min-h-screen bg-gradient-to-b from-white via-neutral-50 to-white">
                ...
                <Container>
                    <div className="pt-12 pb-16 relative">
                        ...
                        <p className="text-neutral-600 mb-6">why does it feel that even though entreprenuership interest is skyrocketing, it&#39;s still so hard for the top students to discover, understand, and involve in the best startups? in fact, it seems like we are always a step late from interning at the next <a href="https://cursor.com/en" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-600">Cursor</a> (would&#39;ve been such a win to know about the company back in 2022)</p> 
